...
use code_common::model_presets::HIDE_GPT_5_2_MIGRATION_PROMPT_CONFIG;
...
use code_core::review_coord::bump_snapshot_epoch;
...
pub async fn run_main(
    ...
    let (env_layer, _log_guard) = if cli.debug {
        ...
        let default_filter =
            "code_core=info,code_tui=info,code_browser=warn,code_auto_drive_core=info";
